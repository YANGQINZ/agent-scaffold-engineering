...
function EngineNode({ id, data, selected }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        'min-w-[180px] rounded-lg border border-purple-200 bg-white shadow-sm transition-all',
        selected && 'ring-2 ring-purple-400 ring-offset-1',
        status === 'running' && 'animate-pulse ring-2 ring-purple-500 ring-offset-1',
    ...
    >
      ...
      <Handle
        ...
        className="!size-3 !border-2 !border-purple-300 !bg-white"
      />
      <Handle
        type="source"
